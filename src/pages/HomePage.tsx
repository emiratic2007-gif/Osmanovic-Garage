              ...
              {SERVICES.map((service) => {
                ...
                return (
                  <motion.div 
                    ...
                    whileHover={{ y: -10 }}
                    className="bg-white text-[#111111] p-8 group transition-all duration-300 flex flex-col h-full"
                  >
                    ...
                    <Link to={`/usluge/${service.id}`} className="inline-flex items-center font-bold text-sm uppercase tracking-widest text-[#FF4500] hover:text-[#111111] transition-colors mt-auto">
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-16">
            ...
            <div>
              ...
              <ul className="space-y-4 text-gray-400 font-medium">
                <li><Link to="/" className="hover:text-[#FF4500] transition-colors">Početna</Link></li>
                <li><Link to="/#about" className="hover:text-[#FF4500] transition-colors">O nama</Link></li>
                <li><Link to="/#services" className="hover:text-[#FF4500] transition-colors">Naše usluge</Link></li>
                <li><Link to="/#book" className="hover:text-[#FF4500] transition-colors">Zakaži termin</Link></li>
              </ul>
            </div>
