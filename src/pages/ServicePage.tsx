...
export default function ServicePage() {
  ...
  if (!service) {
    return (
      <div className="min-h-screen bg-[#111111] flex flex-col items-center justify-center text-white">
        ...
        <Link to="/">
          <Button className="bg-[#FF4500] hover:bg-white hover:text-[#111111] rounded-none font-bold uppercase tracking-widest">
  ...
  return (
    <div className="min-h-screen bg-white text-[#111111] font-sans selection:bg-[#FF4500] selection:text-white flex flex-col">
      {/* HEADER */}
      <header className="sticky top-0 z-50 w-full bg-[#111111] text-white border-b border-white/10">
        <div className="container mx-auto px-4 py-1.5 flex items-center justify-between max-w-7xl">
          ...
          <nav className="hidden md:flex items-center gap-8 font-bold text-sm tracking-widest uppercase">
            <Link to="/" className="hover:text-[#FF4500] transition-colors">Početna</Link>
          </nav>
      ...
      <main className="flex-grow">
        ...
        <section className="relative bg-[#111111] text-white py-20 md:py-32 overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-20 max-w-7xl">
            <Link to="/" className="inline-flex items-center text-gray-400 hover:text-[#FF4500] transition-colors font-bold uppercase tracking-widest text-sm mb-8">
            ...
            >
              <div className="w-16 h-16 bg-[#FF4500] flex items-center justify-center shrink-0">
          ...
          <div className="container mx-auto px-4 max-w-7xl">
            <div className="grid md:grid-cols-2 gap-16 items-start">
              ...
              >
                ...
                <div className="mt-12 space-y-4">
                  ...
                  {[
                    ...
                    <div key={idx} className="flex items-center gap-3">
                      <CheckCircle2 className="w-6 h-6 text-[#FF4500] shrink-0" />
                ...
                <div className="mt-16">
                  <Link to="/#book">
                    <Button className="w-full md:w-auto bg-[#111111] hover:bg-[#FF4500] text-white font-black uppercase tracking-widest rounded-none h-14 px-10 transition-colors">
                      Zakaži ovu uslugu
                    </Button>
                  </Link>
                </div>
              ...
              <motion.div
                ...
                className="relative"
              >
                <div className="absolute inset-0 bg-[#FF4500] translate-x-4 translate-y-4 z-0"></div>
                <img 
                  src={service.image} 
                  alt={service.title} 
